...
export function GlobalTranslateMenu() {
  ...
  const isChinese = containsChinese(selection.text);
  const buttonText = isChinese ? t('translateToEn') : t('translateToZh');
  ...
  return (
    ...
    >
      ...
      <div className="p-3">
        <div className="text-xs text-text-tertiary mb-1">{t('selectedText')}:</div>
      ...
      {!translatedText && !error && (
        <div className="px-3 pb-3">
          ...
          >
            {isTranslating ? tCommon('status.translating') : buttonText}
          </button>
        </div>
      )}
      ...
      {translatedText && (
        <div className="px-3 pb-3">
          <div className="text-xs text-text-tertiary mb-1">{t('translateResult')}:</div>
